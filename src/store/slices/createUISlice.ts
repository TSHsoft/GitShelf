...
export const createUISlice: StateCreator<GitShelfStore, [], [], UISlice> = (set) => ({
    ...
    setSearchTopics: (searchTopics) => set({ searchTopics }),
    setFilterType: (filterType) => set({ filterType, showTrash: false }),
    setFilterFavorite: (filterFavorite) => set({ filterFavorite, showTrash: false }),
    setSearchQuery: (searchQuery) => set({ searchQuery }),
    setSelectedTagId: (selectedTagId) => set({ selectedTagId, selectedRepoIds: new Set(), showTrash: false }),
    setSelectedFolderId: (selectedFolderId) => set({ selectedFolderId, selectedRepoIds: new Set(), showTrash: false }),
