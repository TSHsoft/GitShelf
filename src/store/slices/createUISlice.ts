...
export const createUISlice: StateCreator<GitShelfStore, [], [], UISlice> = (set) => ({
    ...
    setSelectedTagId: (selectedTagId) => set({ selectedTagId, selectedRepoIds: new Set() }),
    setSelectedFolderId: (selectedFolderId) => set({ selectedFolderId, selectedRepoIds: new Set() }),
